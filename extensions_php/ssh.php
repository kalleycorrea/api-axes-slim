...
// http://localhost/api-axes-slim/extensions_php/ssh.php

// Solução Nativa para SSH no PHP
// $connection = ssh2_connect('179.191.232.6', 22);
// ssh2_auth_password($connection, 'root', 'rb2016!');
// ssh2_scp_send($connection, 'filename.png', '/var/www/routerbox/file/docarquivos/filename.png', 0644);

// Solução Alternativa
set_include_path(get_include_path() . '\phpseclib');

// include('Net/SSH2.php');
// $ssh = new Net_SSH2('179.191.232.6');
// if (!$ssh->login('root', 'rb2016!')) {
//    exit('Login Failed');
// }
// echo $ssh->exec('pwd');
// echo $ssh->exec('ls -la');
